...
test_vector_splice( void )	{
	...
	}
	{
		...
		testVector(ft_c0, std_c0,  NOPRINT, "before test on list 0");
		testVector(ft_c1, std_c1,  NOPRINT, "before test on list 1");
		...
		testVector(ft_c0, std_c0,  NOPRINT, "test on list 0");
		testVector(ft_c1, std_c1,  NOPRINT, "test on list 1");
	}
	{
		std::cout << HEADER_TITLE << "[ list 0 with 8 values '0', list 1 with 8 values '1' ]" << RESET_COLOR << std::endl;
